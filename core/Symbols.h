...
public:
    ...
    public:
        ...
        static constexpr u2 REWRITER_SYNTHESIZED = 00001;

        static constexpr u2 METHOD_PROTECTED = 0x0002;
        static constexpr u2 METHOD_PRIVATE = 0x0004;
        static constexpr u2 METHOD_OVERLOADED = 0x0008;
        static constexpr u2 METHOD_ABSTRACT = 0x0010;
        static constexpr u2 METHOD_GENERIC = 0x0020;
        [[deprecated]] static constexpr u2 METHOD_GENERATED_SIG = 0x0040;
        static constexpr u2 METHOD_OVERRIDABLE = 0x0080;
        static constexpr u2 METHOD_FINAL = 0x0100;
        static constexpr u2 METHOD_OVERRIDE = 0x0200;
        [[deprecated]] static constexpr u4 METHOD_IMPLEMENTATION = 0x0400;
        static constexpr u2 METHOD_INCOMPATIBLE_OVERRIDE = 0x0800;
    };
